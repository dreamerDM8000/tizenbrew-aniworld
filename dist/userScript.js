...
(function () {
  ...
  if (window.tizen && window.tizen.tvinputdevice) {
    try {
      ...
      console.warn('[AniWorld] Tizen Tasten konnten nicht registriert werden:', e);
    }
  }
  ...
  function findNearest(direction) {
    ...
    focusableElements.forEach((el, i) => {
      ...
      switch (direction) {
        case 'UP':    isCandidate = dy < -5; break;
        case 'DOWN':  isCandidate = dy > 5;  break;
        case 'LEFT':  isCandidate = dx < -5; break;
        case 'RIGHT': isCandidate = dx > 5;  break;
      }
  ...
  document.addEventListener('keydown', function (e) {
    ...
    switch (e.keyCode) {
      ...
      case KEYS.FF:
        e.preventDefault(); seekVideo(30); break;
      case KEYS.RW:
        e.preventDefault(); seekVideo(-10); break;
    }
  }, true);
  ...
  document.body ? observeBody() : document.addEventListener('DOMContentLoaded', observeBody);
